...
% https://observablehq.com/@toja/line-box-intersection?collection=%40toja%2Fgeometry
...
\todo[inline]{Add \emph{Equations of a circle and an ellipse}}
\index{circle!equations}%
\index{ellipse!equations}%
\skelpar%
\section{Constructions of Circles and Ellipses}
\index{circle!constructions}%
\index{ellipses!constructions}%
\subsection{Construction with given center and radius/radiii.}
...
\todo[inline]{Add \emph{Making a triangle from a point and given angles}}
\skelpar%
\begin{minted}{rust}
\end{minted}
...
%
%
\chapter{Polygons with rounded edges}\index{polygon!rounded edges}\index{polygon!smooth edges}
%https://observablehq.com/@daformat/rounding-polygon-corners
% https://observablehq.com/@mateh/continuous-curvature superformula
\todo[inline]{Add \emph{Polygons with rounded edges}}
\skelpar%
\skelpar%
...
%https://observablehq.com/@daformat/union-polygon-and-area-of-rectangles-line-sweep-algorithm
...
\todo[inline]{Add \emph{Polygon clipping}}
\skelpar%
...
\clearpage{}
\myaddthumb{Curves}{curves}
\part{Curves}
\chapter{Seamlessly joining lines and curves}
\todo[inline]{Add \emph{Seamlessly joining lines and curves}}
\skelpar%
\section{Centre of arc which blends with two given line segments at right angles}
\todo[inline]{Add \emph{Centre of arc which blends with two given line segments at right angles}}
\skelpar%
\section{Centre of arc which blends given line with given circle}
\todo[inline]{Add \emph{Centre of arc which blends given line with given circle}}
\skelpar%
...
\end{figure}
\chapter{B-spline}\index{curves!Basis spline}
\todo[inline]{Add \emph{B-spline}}
\skelpar%
\skelpar%
...
\todo[inline]{Add \emph{Cubic Bézier curves}}
\skelpar%
\section{Weighted Béziers}\index{curves!Bézier!weighted}
\todo[inline]{Add \emph{Weighted Béziers}}
\skelpar%
\chapter{Archimedean spiral}
\todo[inline]{Add \emph{Archimedean spiral}}
\begin{figure}[H]
  \centering
...
\chapter{Anamorphic transformations}
\todo[inline]{Reproduce cover skull}
\skelpar%
\chapter{Projections}
...
\skelpar%
\clearpage{}
\myaddthumb{Patterns}{patterns}
\part{Patterns}
\chapter{The 17 Wallpaper groups}\index{wallpaper groups}
\todo[inline]{Add \emph{The 17 Wallpaper groups}}
% https://observablehq.com/@esperanc/wallpaper-groups
\skelpar%
\skelpar%
\skelpar%
\clearpage{}
\chapter{Tilings and Tessellations}\index{tiling}
...
\end{minted}
\clearpage{}
\section{Pythagorean Tiling}\index{tiling!Pythagorean}\index{Pythagorean tiling}
Pythagorean tiling consists of two squares, one filled and one blank and is described by the ratio of their sizes.
\begin{figure}[H]
\centering
  \fbox{\includegraphics[height=12\baselineskip,keepaspectratio]{figures/pythagorean.pdf}}
  \Caption{Pythagorean tiling using the golden ratio $\phi \equiv{} \frac{1+\sqrt{5}}{2}$}
\end{figure}

\subsection*{The code}
\attachsource{src/bin/pythagorean.rs}
...
\clearpage{}
\chapter{Flow fields}
\todo[inline]{Add \emph{Flow fields}}
% https://tylerxhobbs.com/essays/2020/flow-fields
\skelpar%
\skelpar%
\clearpage{}
\skelpar%
\myaddthumb{Interaction}{interaction}
\part{Interaction}
\skelpar%
\chapter{Infinite panning and zooming}
\todo[inline]{Add \emph{Infinite panning and zooming}}
\skelpar%
\skelpar%
\chapter{Nearest neighbours}
\todo[inline]{Add \emph{Nearest neighbours}}
\skelpar%
\skelpar%
\chapter{Point in polygon}
\todo[inline]{Add \emph{Point in polygon}}
% https://observablehq.com/@tmcw/understanding-point-in-polygon
\skelpar%
\skelpar%
\clearpage{}
\clearpage{}
\myaddthumb{Colors}{colors}
\part{Colors}
\skelpar%
\skelpar%
\chapter{Mixing colors}
\todo[inline]{Add \emph{Mixing colors}}
\skelpar%
\chapter{Bilinear interpolation}
\todo[inline]{Add \emph{Bilinear interpolation}}
\skelpar%
\chapter{Barycentric coordinate blending}
\todo[inline]{Add \emph{Barycentric coordinate blending}}
\skelpar%
\clearpage{}
\clearpage{}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth,keepaspectratio]{figures/atkinson_dithering_peppers_closeup.jpg}\par
  {\scriptsize{}detail of a standard test image, \myurl{https://sipi.usc.edu/database/database.php?volume=misc&image=13}{\emph{peppers}}, with Atkinson dithering}
\end{figure}
\skelpar
