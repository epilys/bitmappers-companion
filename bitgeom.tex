\documentclass[12pt,a4,oneside,usenames,dvipsnames]{book}
  ...
  \newfontfamily\pixeltitle[Scale=3.5]{Redaction20-Regular}
  \newfontfamily\reduxtitle[Scale=3.5]{Redaction}
...
\usepackage[marginparwidth=3cm,twoside=true]{geometry}
  \usepackage{metalogo}
  \usepackage{csquotes}
...
\setminted[rust]{fontsize=\scriptsize,baselinestretch=0.5}
...
\newcommand{\setbackgroundcolour}{\pagecolor[rgb]{0.17,0.17,0.17}}
\newcommand{\settextcolour}{\color[rgb]{0.90,0.90,0.90}}
\newcommand{\invertbackgroundtext}{\setbackgroundcolour\settextcolour}
\newcommand{\revertbackgroundcolour}{\pagecolor[rgb]{1.0,1.0,1.0}}
...
\noindent{}\url{https://github.com/epilys/bitmappers-companion}
...
%
\marginnote{\scriptsize{}This code is also a PDF attachment:\\ \attachfile{src/lib.rs}}%
%
%
\begin{minted}{rust}
...
%
\marginnote{\scriptsize{}This code is also a PDF attachment:\\ \attachfile{src/bin/introduction.rs}}%
%
%
\begin{minted}{rust}
...
fn main() {
    let mut buffer: Vec<u32> = vec![WHITE;
                                    WINDOW_WIDTH *
                                    WINDOW_HEIGHT];
...
%
\marginnote{\scriptsize{}This chapter's code is also a PDF attachment:\\ \attachfile{src/bin/rotation.rs}}%
%
%
\begin{minted}{rust}
include!("dmr.rs");
...
\begin{itemize}
  \item \emph{Redaction} for the main text.
  \item \emph{\fira{}Fira Sans} for referring to the programming language \Rust{}\,.
  \item \emph{\pixel{}Redaction20} for referring to the words \bitmap{} and \pixels{} as a concept.
\end{itemize}
\end{colophon}
\end{document}
