\documentclass[12pt,a4,oneside,usenames,dvipsnames]{book}
  ...
  \newfontfamily\pixeltitle[Scale=2.5]{Redaction20-Regular}
  \newfontfamily\reduxtitle[Scale=2.5]{Redaction}
...
\newcommand\covertitletext{\TitleOutline{A Bitmapper's Companion}}
\title{\titletext{}}
...
\newcommand{\revertbackgroundcolour}{\pagecolor[rgb]{0.98,0.98,0.98}}
...
\marginnote{\footnotesize{}You can easily select and copy the entire code from this shrunk copy:\\\scalebox{0.2}{\usebox{\mintedbox}}}
