\documentclass[12pt,a4,oneside,usenames,dvipsnames]{book}
  ...
  \newfontfamily\thumbfont{Redaction35-Regular}
...
\setminted[rust]{labelposition=bottomline,bgcolor=thepeach,fontsize=\scriptsize,baselinestretch=0.5,frame=leftline,breaklines=true,breakanywhere=true}
...
\usepackage[thumblink=rule,linefill=dots,height=50pt,minheight={50pt},width=50pt,distance={2mm},topthumbmargin={2pt},bottomthumbmargin={2pt},eventxtindent={2pt},oddtxtexdent={0pt},evenmarkindent={0pt},oddmarkexdent={0pt},evenprintvoffset={0pt},nophantomsection=false,ignorehoffset=true,ignorevoffset=true,final=true,hidethumbs=false,verbose=true]{thumbs}
...
\skelpars{2}
\myaddthumb{Points, Line Segments and Arcs}{arcs}
