...
Now, we wish to find the equation of the line that passes through $P$ and is perpendicular to $L$. Let's call it $L_{⊥}$. $L$ in implicit form is $ax+by+c=0$. The perpendicular will be:\index{perpendicular}
...
\end{figure}
Let's name this line $L$. From the previous chapter we know how to get the line that's created by the two points $M$ and $N$. If only we knew how to get a perpendicular line over the midpoint of a line segment!\footnote{See \emph{\nameref{sec:perpendicular}}, page \pageref{sec:perpendicular}}
...
Begin by finding the midpoints $q_1$ and $q_2$ of segments $S_1$ and $S_2$.\index{midpoint} These will be:
...
\noindent{}Calculate perpendicular lines\footnote{See \emph{\nameref{sec:perpendicular}}, page \pageref{sec:perpendicular}} $S'_1$ and $S'_2$ passing through the midpoints of $S_1$ and $S_2$.
