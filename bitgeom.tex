...
The book's library includes a method to load \texttt{xbm} files on runtime (see \emph{\nameref{ch:xbmtors}} for including them in your binary at compile time). If you have another way to load pictures such as your own code or a picture format library crate, all you have to do is convert the pixel information to an \texttt{Image} whose definition we repeat here:
...
\todo[inline]{Add \emph{Angle between two lines} code samples}
\begin{figure}[H]
\centering
...
\todo[inline]{Add \emph{Intersection of two lines} code}
\begin{figure}[H]
\centering
...
\begin{figure}[H]
\centering
\includegraphics[height=13\baselineskip,keepaspectratio]{figures/fillet_main.pdf}
\end{figure}
...
\begin{minipage}{0.8\textwidth}
  \fbox{\includegraphics[width=\textwidth,keepaspectratio]{figures/fillet_1.pdf}}

  \vspace{\baselineskip}
  \noindent{\centering{}Beginning with two line segments $P_{1}P_{2}$ and $P_{3}P_{4}$ that make up segments $S_1$ and $S_2$.}
\end{minipage}
\end{figure}
...
\begin{figure}[H]
\begin{minipage}{0.8\textwidth}
  \fbox{\includegraphics[width=\textwidth,keepaspectratio]{figures/fillet_2.pdf}}

  \vspace{\baselineskip}
  \noindent{\centering{}Calculate perpendicular lines $S'_1$ and $S'_2$ passing through the midpoints of $S_1$ and $S_2$.}
\end{minipage}
\end{figure}
\begin{figure}[H]
  \begin{minipage}{0.8\textwidth}
    \fbox{\includegraphics[width=\textwidth,keepaspectratio]{figures/fillet.pdf}}

    \vspace{\baselineskip}
    \noindent{\centering{}At their intersection lies the center $P_c$ of the circle, and the radius is the distance of $P_c$ from either of the segments.}
  \end{minipage}
\end{figure}
\todo[inline]{Add \emph{Join segments with round corners} code}
...
\todo[inline]{Add \emph{flowsnake curve}}
