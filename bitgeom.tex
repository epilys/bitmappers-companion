...
%
We need the perpendicular line over the midpoint of $L$.\footnote{See \emph{\nameref{sec:perpendicular}}, page \pageref{sec:perpendicular}} The midpoint also satisfies $L$'s equation. The midpoint's coordinates are intuitively:\index{midpoint}
